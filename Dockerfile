...
RUN apt-get -qqy update \
    ...
    && wget https://downloads.realvnc.com/download/file/vnc.files/VNC-Server-6.9.1-Linux-x64.deb \
    && apt install -qqy --no-install-recommends ./VNC-Server-6.9.1-Linux-x64.deb \
